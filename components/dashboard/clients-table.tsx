          ...
          {clients.map((client, index) => (
            ...
            >
              ...
              <TableCell>
                ...
                >
                  {client.status === 'pago' ? 'Paid' : 'Pending'}
                </Badge>
              </TableCell>
              <TableCell>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-40">
                    {client.status === 'pendente' && (
                      <DropdownMenuItem onClick={() => handleMarkAsPaid(client.id)}>
            ...
            <CardContent className="p-4">
              ...
              <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-medium text-foreground">{formatCurrency(client.monthly_price)}</p>
                </div>
                <div>
                  <p className="text-muted-foreground">Due Date</p>
                  <p className="font-medium text-foreground">{formatDate((client as ClientWithDate).dueDate || new Date(client.created_at))}</p>
                </div>
                {client.phone && (
